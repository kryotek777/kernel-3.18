...
#define VOL_1000 1000000
	...
	if (On) {
		...
		ISP_MCLK1_EN(1);
		if (pinSetIdx == 0 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_OV5648_MIPI_RAW))) {
			...
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST])
				mtkcam_gpio_set(pinSetIdx, CAMRST, pinSet[pinSetIdx][IDX_PS_CMRST + IDX_PS_ON]);
		          ...
		          //add clj 20160116 
  		else if (currSensorName && pinSetIdx == 0 && (0 == strcmp(currSensorName, SENSOR_DRVNAME_OV5670_MIPI_RAW)))
       {
	  ...
	  PK_DBG("clj3[PowerON]pinSetIdx:%d, currSensorName: %s\n", pinSetIdx, currSensorName);
      ...
      //enable active sensor
	    ...
	    if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
		  mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_ON]);  
	  PK_DBG("clj7[PowerON]pinSetIdx:%d, currSensorName: %s\n", pinSetIdx, currSensorName);

      mdelay(15);
       }
	   
	   
       	else if ((pinSetIdx==1) && currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2355_MIPI_RAW, currSensorName)))
				{
#if 1
				 //disable inactive sensor
				 PK_DBG("clj4[PowerON]pinSetIdx:%d, currSensorName: %s\n", pinSetIdx, currSensorName);
				 ...
				 PK_DBG("clj5[PowerON]pinSetIdx:%d, currSensorName: %s\n", pinSetIdx, currSensorName);
				...
				//enable active sensor
				 ...
				 PK_DBG("clj6[PowerON]pinSetIdx:%d, currSensorName: %s\n", pinSetIdx, currSensorName);
				
				}

		
				//end add clj 20160116
		...
		if (pinSetIdx == 0 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_OV5648_MIPI_RAW))) {
	      ...
	      else if (pinSetIdx == 1 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_GC2355_MIPI_RAW)))
