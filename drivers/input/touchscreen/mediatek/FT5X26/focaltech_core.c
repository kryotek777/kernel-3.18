...
static void tpd_charger_check(int resume)
{
    ...
    //TPD_DMESG("[FTS] charger_state: %d, cur_state: %d\n",charger_state, ft5x46_charger_state);
...
//By Gujh_Eric, 2016/5/26, 10:26:47 // 			TPD_DMESG("I2C write report rate error, line: %d\n", __LINE__);
...
//By Gujh_Eric, 2016/5/26, 10:26:53 // 		if ((fts_write_reg(i2c_client, 0x88, report_rate)) < 0)
//By Gujh_Eric, 2016/5/26, 10:26:53 // 			TPD_DMESG("I2C write report rate error, line: %d\n", __LINE__);
